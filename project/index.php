...
//    include 'login.php';
    ...
    <div id="form">
        ...
        <div id="register"><button id="btn">Влез</button> <p>или се <a href="register.php">регистирай</a></p></div>
...
<html>
    ...
    <body>
        ...
        <div id="header"><p>Здравей,   <?php echo $_SESSION['user']['user_name'] . '</br><a href="logout.php">Изход</a>' ?></p></div>
        ...
        <div id="content">
            <?php
            echo '<img src="MAP-DARK.jpg" alt=""  usemap="#Map"/>';
            echo '<br>';
            echo '<img src="global.png" />';
