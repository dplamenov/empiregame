...
CREATE TABLE `digia_greatempire`.`users_building` (
  ...
  `build_lv`   INT        NOT NULL
)
  ENGINE = InnoDB;

ALTER TABLE `building_now`
  ADD `building_id` INT NOT NULL
  AFTER `end_time`;
...
ALTER TABLE `building`
  ADD `geo_id` VARCHAR(50) CHARACTER SET utf8
COLLATE utf8_general_ci NOT NULL
  AFTER `building_id`;

ALTER TABLE `building`
  ADD `geo_location` VARCHAR(150) NOT NULL
  AFTER `geo_id`;

ALTER TABLE `army`
  ADD `army_name` VARCHAR(80) CHARACTER SET utf8
COLLATE utf8_general_ci NOT NULL
  AFTER `army_id`;
...
CREATE TABLE `digia_greatempire`.`army_now` (
  ...
  `end_time`  INT NOT NULL,
  `army_num`  INT NOT NULL
)
  ENGINE = InnoDB;

CREATE TABLE `digia_greatempire`.`user_army` (
  `user_id`   INT NOT NULL,
  `army_name` INT NOT NULL,
  `count`     INT NOT NULL,
  `lvl`       INT NOT NULL
...
ALTER TABLE `army`
  ADD `give_xp` INT NOT NULL
  AFTER `army_name`;

ALTER TABLE `users`
  CHANGE `real_name` `real_name` VARCHAR(80) CHARACTER SET utf8
COLLATE utf8_general_ci NOT NULL;
